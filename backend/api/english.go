...
var EnglishMessages = map[string]string{
	...
	"ask_app_tech":                 "🛠 Which technology should the app use?\n\n📱 *Flutter* — an Android app (an APK file you install on a phone)\n🌐 *Web* — a web app (JavaScript, a live website with a link, opens in a browser)",
	"btn_tech_flutter":             "📱 Flutter (APK)",
	"btn_tech_web":                 "🌐 Web (live site)",
	"ask_app_name":                 "🏗 Describe what the app should be (e.g. \"social app with profile, messages, search\") — the AI will build it:",
	"ask_app_name_web":             "🌐 Describe your web app (e.g. \"online shop\" or \"social network\") — the AI will build it and I'll give you a live website link:",
	"web_deploying":                "🌐 Publishing the site to GitHub Pages, hang on... (can take a couple minutes)",
	"web_created":                  "✅ Done! Your site is live:\n\n🔗 %s\n\nRepo: `%s`\nGitHub: %s\n\n(If it doesn't open yet, wait 1-2 minutes — GitHub Pages needs a moment.)",
	"web_deploy_timeout":           "⏳ The site was created but isn't live yet (GitHub Pages needs time). Check the repo link on GitHub in a couple minutes.",
	"web_pages_failed":             "😔 Couldn't enable GitHub Pages. The token may not have Pages permission.",
